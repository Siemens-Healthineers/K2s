...
PS> .\smallsetup\helpers\GpoManager.ps1 -method "Shutdown" -methodscript "C:\k\lib\scripts\windows\host\stop\stop.ps1"
...
Param (
    ...
    [string] $methodScript = 'C:\k\lib\scripts\windows\host\stop\stop.ps1',
