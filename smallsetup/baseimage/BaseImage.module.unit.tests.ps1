...
Describe 'Helpers' -Tag 'unit', 'baseimage' {
	...
	Describe 'Convert-Text' -Tag 'unit', 'baseimage' {
...
Describe 'New-VhdxDebianCloud' -Tag 'unit', 'baseimage' {
...
Describe 'Get-DebianImage' -Tag 'unit', 'baseimage' {
	It "using proxy '<ProxyValue>'" -ForEach @(
        @{ ProxyValue = '' }
        @{ ProxyValue = 'a particular proxy' }
		@{ ProxyValue = 'the default one' }
...
Describe 'Get-QemuTool' -Tag 'unit', 'baseimage' {
	It "using proxy '<ProxyValue>'" -ForEach @(
        @{ ProxyValue = '' }
        @{ ProxyValue = 'a particular proxy' }
		@{ ProxyValue = 'the default one' }
...
Describe 'New-VhdxFile' -Tag 'unit', 'baseimage' {
...
Describe 'New-IsoFile' -Tag 'unit', 'baseimage' {
...
Describe 'New-VirtualMachineForBaseImageProvisioning' -Tag 'unit', 'baseimage' {
...
Describe 'Remove-VirtualMachineForBaseImageProvisioning' -Tag 'unit', 'baseimage' {
...
Describe 'Connect-VmToSwitch' -Tag 'unit', 'baseimage' {
	It "arguments validation" {
        InModuleScope $moduleName {
			$invalidValues = @($null, '', '   ')
...
Describe 'Disconnect-VmFromSwitch' -Tag 'unit', 'baseimage' {
	It "arguments validation" {
        InModuleScope $moduleName {
			$invalidValues = @($null, '', '   ')
...
Describe 'Start-VirtualMachineAndWaitForHeartbeat' -Tag 'unit', 'baseimage' {
	It "arguments validation" {
        InModuleScope $moduleName {
			$invalidValues = @($null, '', '   ')
...
Describe 'Stop-VirtualMachineForBaseImageProvisioning' -Tag 'unit', 'baseimage' {
	It "arguments validation" {
        InModuleScope $moduleName {
			$invalidValues = @($null, '', '   ')
...
Describe 'Remove-SshKeyFromKnownHostsFile' -Tag 'unit', 'baseimage' {
	It "arguments validation" {
        InModuleScope $moduleName {
...
Describe 'Copy-LocalPublicSshKeyToRemoteComputer' -Tag 'unit', 'baseimage' {
	It 'arguments validation' {
        InModuleScope $moduleName {
