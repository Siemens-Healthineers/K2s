...
# Usage c:\g\ci\windows\buildbox\Windows10SysPrepDebloater.ps1 -Sysprep -Debloat
...
Function Start-Debloat {
    ...
    Microsoft.VP9VideoExtensions|Microsoft.WebMediaExtensions|Microsoft.WebpImageExtension|Microsoft.DesktopAppInstaller|Microsoft.MicrosoftEdge.Stable'
...
Function Protect-Privacy {
    ...
    If (Test-Path $CloudStore) {
        $checkProcess = Get-Process -Name explorer -ErrorAction SilentlyContinue
        if ($checkProcess) {
