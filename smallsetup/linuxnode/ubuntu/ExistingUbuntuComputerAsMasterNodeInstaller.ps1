...
New-KubernetesNode -UserName $newUserName -UserPwd $newUserPwd -IpAddress $IpAddress -K8sVersion $global:KubernetesVersion -CrioVersion $global:CrioVersion -Proxy $Proxy
