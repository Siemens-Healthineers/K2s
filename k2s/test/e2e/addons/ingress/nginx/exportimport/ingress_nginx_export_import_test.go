...
var _ = Describe("ingress nginx addon export and import", Ordered, func() {
	Describe("export ingress nginx addon", func() {
		...
		It("exports ingress nginx addon to versioned zip file", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: exports ingress nginx addon to versioned zip file")
			exportedZipFile = exportimport.ExportAddon(ctx, suite, "ingress", "nginx", exportPath)
		...
		It("contains ingress nginx addon folder with correct structure", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: contains ingress nginx addon folder with correct structure")
