...
func TestRegistryExportImport(t *testing.T) {
	...
	RunSpecs(t, "registry Addon Export/Import Tests", Label("addon", "addon-diverse", "acceptance", "internet-required", "setup-required", "invasive", "registry", "export-import", "system-running"))
}
