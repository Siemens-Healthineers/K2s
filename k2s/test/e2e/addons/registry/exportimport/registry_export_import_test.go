...
var _ = Describe("registry addon export and import", Ordered, func() {
	Describe("export registry addon", func() {
		...
		It("exports registry addon to versioned zip file", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: exports registry addon to versioned zip file")
			exportedZipFile = exportimport.ExportAddon(ctx, suite, "registry", "", exportPath)
		...
		It("contains registry addon folder with correct structure", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: contains registry addon folder with correct structure")
