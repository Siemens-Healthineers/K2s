...
var _ = Describe("autoscaling addon export and import", Ordered, func() {
	Describe("export autoscaling addon", func() {
		...
		It("exports autoscaling addon to versioned zip file", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: exports autoscaling addon to versioned zip file")
			exportedZipFile = exportimport.ExportAddon(ctx, suite, "autoscaling", "", exportPath)
		...
		It("contains autoscaling addon folder with correct structure", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: contains autoscaling addon folder with correct structure")
