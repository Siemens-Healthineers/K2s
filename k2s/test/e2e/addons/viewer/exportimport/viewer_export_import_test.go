...
var _ = Describe("viewer addon export and import", Ordered, func() {
	Describe("export viewer addon", func() {
		...
		It("exports viewer addon to versioned zip file", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: exports viewer addon to versioned zip file")
			exportedZipFile = exportimport.ExportAddon(ctx, suite, "viewer", "", exportPath)
		...
		It("contains viewer addon folder with correct structure", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: contains viewer addon folder with correct structure")
