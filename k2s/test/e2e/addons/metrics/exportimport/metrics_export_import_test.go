...
var _ = Describe("metrics addon export and import", Ordered, func() {
	Describe("export metrics addon", func() {
		...
		It("exports metrics addon to versioned zip file", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: exports metrics addon to versioned zip file")
			exportedZipFile = exportimport.ExportAddon(ctx, suite, "metrics", "", exportPath)
		...
		It("contains metrics addon folder with correct structure", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: contains metrics addon folder with correct structure")
