...
func TestMetricsExportImport(t *testing.T) {
	...
	RunSpecs(t, "metrics Addon Export/Import Tests", Label("addon", "addon-ilities", "acceptance", "internet-required", "setup-required", "invasive", "metrics", "export-import", "system-running"))
}
