...
var _ = Describe("logging addon export and import", Ordered, func() {
	Describe("export logging addon", func() {
		...
		It("exports logging addon to versioned zip file", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: exports logging addon to versioned zip file")
			exportedZipFile = exportimport.ExportAddon(ctx, suite, "logging", "", exportPath)
		...
		It("contains logging addon folder with correct structure", func(ctx context.Context) {
			GinkgoWriter.Println(">>> TEST: contains logging addon folder with correct structure")
