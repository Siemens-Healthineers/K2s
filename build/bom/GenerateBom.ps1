...
function GenerateBomDebian() {
    ...
    $startTime = Get-Date
    ExecCmdMaster -CmdToExecute "sudo HTTPS_PROXY=$kubemasterProxy /usr/bin/trivy rootfs / --scanners license --license-full --format cyclonedx -o kubemaster.json 2>&1" -Retries 6 -Timeout 30
