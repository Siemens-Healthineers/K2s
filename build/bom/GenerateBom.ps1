...
function EnsureTrivy() {
    ...
    DownloadFile $compressedFile 'https://github.com/aquasecurity/trivy/releases/download/v0.69.3/trivy_0.69.3_windows-64bit.zip' $true -ProxyToUse $Proxy
...
function GenerateBomDebian() {
    ...
    if ($trivyInstalled -match '/bin/trivy') {
        ...
        ExecCmdMaster 'sudo curl --proxy http://172.19.1.1:8181 -sLO https://github.com/aquasecurity/trivy/releases/download/v0.69.3/trivy_0.69.3_Linux-64bit.tar.gz 2>&1'
        ExecCmdMaster 'sudo tar -xzf ./trivy_0.69.3_Linux-64bit.tar.gz trivy'
        ExecCmdMaster 'sudo rm ./trivy_0.69.3_Linux-64bit.tar.gz'
