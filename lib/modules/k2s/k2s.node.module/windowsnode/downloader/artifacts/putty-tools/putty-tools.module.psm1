...
function Invoke-DownloadPlink {
    ...
    Invoke-DownloadFile $Destination https://the.earth.li/~sgtatham/putty/0.81/w64/$windowsNode_Plink $true $Proxy
}
...
function Invoke-DownloadPscp {
    ...
    Invoke-DownloadFile $Destination https://the.earth.li/~sgtatham/putty/0.81/w64/$windowsNode_Pscp $true $Proxy
}
