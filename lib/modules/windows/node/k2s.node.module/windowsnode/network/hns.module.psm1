...
function New-HnsNamespace {
    ...
    if($null -ne $Endpoints)
    {
        Foreach ($endpoint in $endpoints)
        {
            ...
            Edit-HnsNamespace -ID $output.Id -Settings $Settings -RequestType $requestType -ResourceType $resourceType
        }
    }
...
function Edit-HnsNamespace
{
    ...
    return Edit-HnsGeneric -Id $Id -NativeMethods $NamespaceNativeMethods -Settings $msettings
}
...
function Edit-HnsLoadBalancer
{
    ...
    return Edit-HnsGeneric -Id $Id -NativeMethods $LoadBalancerNativeMethods -Settings $msettings
}
...
function Edit-HnsNetworkDNS
{
    ...
    Edit-HnsNetwork -Id $Id -RequestType $RequestType -ResourceType $ResourceType -Settings $Settings
}
...
function Update-HnsNetworkDNS
{
    ...
    Edit-HnsNetworkDNS -Id $Id -RequestType $RequestType -ResourceType $ResourceType -Domain `
...
function New-HnsNetworkPolicy
{
    ...
    Edit-HnsNetwork -Id $NetworkId -RequestType $requestType -ResourceType $resourceType -PolicyArray $Policies
}
...
function New-HnsSubnet
{
    ...
    Edit-HnsNetwork -Id $NetworkId -RequestType $requestType -ResourceType $resourceType -SubnetArray $Subnets
}
...
function New-HnsIPSubnet
{
    ...
    Edit-HnsNetwork -Id $NetworkId -RequestType $requestType -ResourceType $resourceType -SubnetId $SubnetId -IPSubnetArray $IPSubnets
}
...
function Edit-HnsNetwork
{
    ...
    return Edit-HnsGeneric -Id $Id -NativeMethods $NetworkNativeMethods -Settings $msettings
}
#########################################################################
# Endpoints
#########################################################################
...
function Edit-HnsEndpoint
{
    ...
    return Edit-HnsGeneric -Id $Id -NativeMethods $EndpointNativeMethods -Settings $msettings
}
...
function Add-HnsEndpointVmPort
{
    ...
    Edit-HnsEndpoint -Id $Id -RequestType $requestType -ResourceType $resourceType -Settings $settings
}
...
function Add-HnsEndpointPolicy {
    ...
    foreach ($id in $Endpoints) {
        ...
        Edit-HnsEndpoint -Id $Id -RequestType $requestType -ResourceType $resourceType -PolicyArray $Policies
    }
}
...
function Edit-HnsGuestNetworkService
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $Id,
    ...
    return Edit-HnsGeneric -Id $Id -NativeMethods $GuestNetworkServiceNativeMethods -Settings $msettings
}

function Edit-HnsGuestNetworkServiceState
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $Id,
    ...
    Edit-HnsGuestNetworkService -Id $Id -RequestType $requestType -ResourceType $resourceType -Settings @{ State = "$State"}
}
...
function Invoke-AttachHnsHostEndpoint
{
    param
    (
...
function Invoke-AttachHnsVMEndpoint
{
    param
    (
     [parameter(Mandatory=$true)] [Guid] $EndpointID,
...
function Invoke-AttachHnsEndpoint
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $EndpointID,
...
function Invoke-DetachHnsVMEndpoint
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $EndpointID
...
function Invoke-DetachHnsHostEndpoint
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $EndpointID
...
function Invoke-DetachHnsEndpoint
{
    param
    (
        [parameter(Mandatory=$true)] [Guid] $EndpointID,
...
Export-ModuleMember -Function Edit-HnsNetwork
...
Export-ModuleMember -Function Edit-HnsEndpoint
...
Export-ModuleMember -Function Edit-HnsNamespace
...
Export-ModuleMember -Function Edit-HnsLoadBalancer
...
Export-ModuleMember -Function Edit-HnsGuestNetworkService
Export-ModuleMember -Function Edit-HnsGuestNetworkServiceState
Export-ModuleMember -Function Invoke-AttachHnsHostEndpoint
Export-ModuleMember -Function Invoke-AttachHnsVMEndpoint
Export-ModuleMember -Function Invoke-AttachHnsEndpoint
Export-ModuleMember -Function Invoke-DetachHnsHostEndpoint
Export-ModuleMember -Function Invoke-DetachHnsVMEndpoint
Export-ModuleMember -Function Invoke-DetachHnsEndpoint
