...
function Invoke-DownloadNerdctlArtifacts($downloadsBaseDirectory, $Proxy, $windowsNodeArtifactsDirectory) {
    ...
    $compressedNerdFile = 'nerdctl-2.4.0-windows-amd64.tar.gz'
    ...
    Invoke-DownloadFile "$compressedFile" https://github.com/containerd/nerdctl/releases/download/v2.4.0/$compressedNerdFile $true $Proxy
    Write-Log '  ...done'
    Write-Log "Extract downloaded file '$compressedFile'"
