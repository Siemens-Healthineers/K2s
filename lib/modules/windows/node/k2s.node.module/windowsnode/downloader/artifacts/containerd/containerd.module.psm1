...
function Invoke-DownloadNerdctlArtifacts($downloadsBaseDirectory, $Proxy, $windowsNodeArtifactsDirectory) {
    ...
    $compressedNerdFile = 'nerdctl-2.3.5-windows-amd64.tar.gz'
    ...
    Invoke-DownloadFile "$compressedFile" https://github.com/containerd/nerdctl/releases/download/v2.3.5/$compressedNerdFile $true $Proxy
    Write-Log '  ...done'
    Write-Log "Extract downloaded file '$compressedFile'"
