...
Once the addons are enabled, then the logging dashboard UI can be accessed at the following link: https://k2s.cluster.local/logging/ and https://k2s-logging.cluster.local (with HTTP using http://.. unstead of https://..)
