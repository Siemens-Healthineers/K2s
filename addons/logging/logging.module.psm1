...
function Write-UsageForUser {
 ...
 The opensearch dashboard will be accessible on the following URL: https://k2s.cluster.local/logging/ and http://k2s-logging.cluster.local (with HTTP using http://.. unstead of https://..)
