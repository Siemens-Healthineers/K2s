...
PROCESS
{
    ...
    else
    {
     <# Edit line 392 to modify the default command run when this script is executed.
       ...
       #>
      # Set-UserRights -RemoveRight -UserRight SeDenyNetworkLogonRight -Username S-1-5-113
        Set-UserRights -RemoveRight -UserRight SeDenyNetworkLogonRight -Username S-1-5-113
        Set-UserRights -AddRight -UserRight SeNetworkLogonRight -Username remotesmb
    }
}
END
{
