...
<#[
.SYNOPSIS
Restores ingress traefik configuration/resources
...
.EXAMPLE
powershell <installation folder>\addons\ingress\traefik\Restore.ps1 -BackupDir C:\Temp\ingress-traefik-backup
#>
Param(
...
try {
    ...
    $errMsg = "Restore of addon 'ingress traefik' failed: $($_.Exception.Message)"
