...
$success = (Invoke-Kubectl -Params 'wait', '--timeout=10s', '--for=condition=Available', '-n', 'rollout', 'deployment/argocd-applicationset-controller').Success
...
$success = (Invoke-Kubectl -Params 'wait', '--timeout=10s', '--for=condition=Available', '-n', 'rollout', 'deployment/argocd-dex-server').Success
...
$success = (Invoke-Kubectl -Params 'wait', '--timeout=10s', '--for=condition=Available', '-n', 'rollout', 'deployment/argocd-notifications-controller').Success
...
$success = (Invoke-Kubectl -Params 'wait', '--timeout=10s', '--for=condition=Available', '-n', 'rollout', 'deployment/argocd-redis').Success
...
$success = (Invoke-Kubectl -Params 'wait', '--timeout=10s', '--for=condition=Available', '-n', 'rollout', 'deployment/argocd-repo-server').Success
...
$success = (Invoke-Kubectl -Params 'wait', '--timeout=10s', '--for=condition=Available', '-n', 'rollout', 'deployment/argocd-server').Success
...
$success = (Invoke-Kubectl -Params 'rollout', 'status', 'statefulsets', '-n', 'rollout', '--timeout=10s').Success
