...
&$global:KubectlExe wait --timeout=5s --for=condition=Available -n traefik deployment/traefik 2>&1 | Out-Null
...
$externalIp = &$global:KubectlExe get service traefik -n traefik -o jsonpath="{.spec.externalIPs[0]}"
