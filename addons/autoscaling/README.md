...
## Scaling
KEDA supports a wide range of [scalers](https://keda.sh/docs/2.18/scalers/) e.g. [CPU](https://keda.sh/docs/2.18/scalers/cpu/) or [Memory](https://keda.sh/docs/2.18/scalers/memory/). KEDA scalers can both detect if a deployment should be activated or deactivated, and feed custom metrics for a specific event source.
