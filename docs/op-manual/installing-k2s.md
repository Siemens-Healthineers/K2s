...
- *Installing in WSL mode*: Turn on the WSL 2 feature on Windows. For detailed instructions, refer to [Configure WSL.](https://docs.microsoft.com/en-us/windows/wsl/install-win10)
   ```powershell
