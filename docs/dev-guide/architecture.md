...
|-------|----------|---------|
| **CLI orchestration** | `lib/scripts/windows/host/` | Top-level Windows scripts invoked by `k2s.exe`: lifecycle, image management, system operations, and shared script helpers. |
